...
const CONFIG = {
    ...
    colors: {
        ...
        buttonBackground: "#FF8A8A",     // Button color (should stand out against the background)
        buttonHover: "#FFA3A3",          // Button hover color (slightly lighter than buttonBackground)
